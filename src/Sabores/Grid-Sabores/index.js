...
import Imagem5Grid from './sorbet-morango.png';
import Imagem6Grid from './sorbet-limao.png';
...
export default function GridSabores(){
    return(
        <div class = "grid-sabores">
            ...
            <div className = "card"><img src = {Imagem2Grid}/><h2>Sorvete Pistache</h2><p>Delicioso sorvete sabor Oreo<br/>uma explosão de sabor</p></div>
            <div className = "card"><img src = {Imagem3Grid}/><h2>Sorvete Cookies</h2><p>Delicioso sorvete sabor Oreo<br/>uma explosão de sabor</p></div>
            </div>
            <div className = "container">
